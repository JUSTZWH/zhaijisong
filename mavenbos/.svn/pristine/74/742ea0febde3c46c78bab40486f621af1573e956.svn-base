...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<s:form namespace="/" action="login" id="loginform" name="loginform" method="post" class="niceform" target="_top">
					<s:actionerror/>
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<s:textfield id="loginform:idInput" name="username"
							cssClass="loginFormTdIpt" maxlength="50" tabindex="1" title="请输入帐号" ></s:textfield>
